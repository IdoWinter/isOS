...
void setup_gdt()
{
  ...
  gdt_entries[1] = gdt_set_gate(0, 0xFFFFFFFF, 0x9A, 0xCF); //Readable kernel code
  gdt_entries[2] = gdt_set_gate(0, 0xFFFFFFFF, 0x92, 0xCF); //writable kernel data
  gdt_entries[3] = gdt_set_gate(0, 0xFFFFFFFF, 0xFA, 0xCF); //Readable user code
  gdt_entries[4] = gdt_set_gate(0, 0xFFFFFFFF, 0xF2, 0xCF); //writable user data
  gdt_write((unsigned int)&gdt_ptr);

}


void idt_set_gate(unsigned char index, unsigned int offset, unsigned short selector, unsigned char flags)
{
